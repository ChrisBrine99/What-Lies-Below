...
var _bloomThreshold, _bloomRange, _blurSteps, _sigma, _bloomIntensity, _bloomDarken, _bloomSaturation;
_bloomThreshold = argument0;
_bloomRange = argument1;
_blurSteps = argument2;
_sigma = argument3;
_bloomIntensity = argument4;
_bloomDarken = argument5;
_bloomSaturation = argument6;
