...
menu_initialize(-1, -1, 3, 3, 1, 0, 0, 30, 0.4); // TODO -- Place transition and its arguments where the -1s are located
...
menu_init_options((global.cameraSize[X] / 2) - _optionOffset, 3, fa_center, fa_top, _optionOffset, 0, font_gui_medium);
